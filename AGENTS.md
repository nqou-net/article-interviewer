...
本ドキュメントは、article-interviewer プロジェクト向けに最適化された GitHub Copilot カスタムエージェントの使い方ガイドです。インタビューを通じて、読者の皆様に価値ある技術ブログ記事をお届けすることを目指しています。
...
各エージェントの詳細な定義は `.github/agents/` ディレクトリに格納されています。

| エージェント名 | 説明 | 役割 | 定義ファイル |
|---|---|---|---|
| **コンテンツ戦略エージェント** | ブログ記事の企画・構成を専門とする | planning | [content_strategist.md](.github/agents/content_strategist.md) |
| **テクニカルライターエージェント** | インタビュー内容を読みやすい技術ブログ記事に仕上げる | writing | [technical_writer.md](.github/agents/technical_writer.md) |
| **インタビューファシリテーターエージェント** | 記事作成に必要な情報を引き出す構造化インタビュー | facilitation | [interview_facilitator.md](.github/agents/interview_facilitator.md) |
| **SEO 最適化エージェント** | 検索エンジン最適化を通じて記事の到達性を高める | optimization | [seo_optimizer.md](.github/agents/seo_optimizer.md) |
| **品質保証エージェント** | 記事の品質を確認し、公開基準を満たしているか検証する | review | [qa_reviewer.md](.github/agents/qa_reviewer.md) |
| **セッション解説者エージェント** | GitHub Copilot Tasks や AI エージェントのセッションログを初心者向けに解説 | education | [session_explainer.md](.github/agents/session_explainer.md) |
...
- ファイル命名規則に従う
  - 記事ファイルはスラッグ形式（例: `creating-agents-md-with-github-copilot.md`）
  - 小文字英数字とハイフンを使用
  - 内容を端的に表す名前を付ける
- 引用元と出典情報を保持
